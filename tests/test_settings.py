...
TEST_SETTINGS = {
    ...
    "indexes": {"baz": {"models": ["tests.IndexedModel"]}},
...
class SettingsFunctionTests(TestCase):
    ...
    def test_get_index_models(self):
        ...
        self.assertEqual(models, [apps.get_model("tests", "IndexedModel")])

    @override_settings(SEARCH_SETTINGS=TEST_SETTINGS)
    def test_get_model_indexes(self):
        """Test the get_model_indexes function."""
        # IndexedModel is in the TEST_SETTINGS
        self.assertEqual(get_model_indexes(IndexedModel), ["baz"])
    ...
    def test_get_document_models(self):
        ...
        self.assertEqual(get_document_models(), {"baz.indexedmodel": IndexedModel})

    @override_settings(SEARCH_SETTINGS=TEST_SETTINGS)
    def test_get_document_model(self):
        """Test the get_document_model function."""
        self.assertEqual(get_document_model("baz", "indexedmodel"), IndexedModel)
    ...
    def test_auto_sync(self):
        ...
        TEST_SETTINGS["settings"]["never_auto_sync"].append("tests.indexedmodel")
        self.assertEqual(auto_sync(obj), False)
