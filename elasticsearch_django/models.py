...
class SearchDocumentMixin(object):
    ...
    def update_search_document(self, *, index, update_fields):
        ...
        see: https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-update.html  # noqa: E501
...
class SearchQuery(models.Model):
    ...
    # The query property contains the raw DSL query, which can be arbitrarily
    # complex - there is no one way of mapping input text to the query itself.
    # However, it's often helpful to have the terms that the user themselves
    # typed easily accessible without having to parse JSON.
    ...
    @property
    def page_size(self):
        """Return the number of hits returned in this specific page."""
